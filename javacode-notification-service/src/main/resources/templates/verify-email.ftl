    ...
    <tr>
        <td align="center">
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        ...
                                        <p>Thanks for trying CodeBrains. We’re thrilled to have you on board. To get the most out of CodeBrains, do this primary next step:</p>
                                        <!-- Action -->
              ...
              <strong>Login Page:</strong> &nbsp; &nbsp; <a href="${login_url}" class="f-fallback button" target="_blank">Login</a> <br><br>
            </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
